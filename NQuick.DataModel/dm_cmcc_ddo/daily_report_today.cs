...
namespace NQuick.Model.DmCmccDdo
{
	...
	public partial class daily_report_today : Entity 
	{
		...
		/// 
		/// </summary>
		public string closed_cpid
		{
			get{ return _closed_cpid; }
			set
			{
				this.OnPropertyValueChange(_.closed_cpid,_closed_cpid,value);
				this._closed_cpid=value;
			}
		}
		#endregion
		...
		public class _
		{
			...
			/// 归属公司
			/// </summary>
			public readonly static Field sp_id = new Field("sp_id","daily_report_today","归属公司");
			/// <summary>
			/// 合作方编号
			/// </summary>
			public readonly static Field cp_id = new Field("cp_id","daily_report_today","合作方编号");
			/// <summary>
			/// 业务代码
			/// </summary>
			public readonly static Field product_id = new Field("product_id","daily_report_today","业务代码");
			/// <summary>
			/// 省份代码
			/// </summary>
			public readonly static Field province_id = new Field("province_id","daily_report_today","省份代码");
			/// <summary>
			/// 上行总数
			/// </summary>
			public readonly static Field all_mo_num = new Field("all_mo_num","daily_report_today","上行总数");
			/// <summary>
			/// 上行总用户数
			/// </summary>
			public readonly static Field all_mo_user = new Field("all_mo_user","daily_report_today","上行总用户数");
			/// <summary>
			/// 上行去重总数
			/// </summary>
			public readonly static Field all_mo_dst_num = new Field("all_mo_dst_num","daily_report_today","上行去重总数");
			/// <summary>
			/// 上行去重总用户数
			/// </summary>
			public readonly static Field all_mo_dst_user = new Field("all_mo_dst_user","daily_report_today","上行去重总用户数");
			/// <summary>
			/// 成功上行总数
			/// </summary>
			public readonly static Field mo_succ_num = new Field("mo_succ_num","daily_report_today","成功上行总数");
			/// <summary>
			/// 成功上行去重数
			/// </summary>
			public readonly static Field mo_succ_dst_num = new Field("mo_succ_dst_num","daily_report_today","成功上行去重数");
			/// <summary>
			/// 成功上行用户数
			/// </summary>
			public readonly static Field mo_succ_user = new Field("mo_succ_user","daily_report_today","成功上行用户数");
			/// <summary>
			/// 成功上行去重用户数
			/// </summary>
			public readonly static Field mo_succ_dst_user = new Field("mo_succ_dst_user","daily_report_today","成功上行去重用户数");
			/// <summary>
			/// 下行总数
			/// </summary>
			public readonly static Field all_mt_num = new Field("all_mt_num","daily_report_today","下行总数");
			/// <summary>
			/// 下行总用户数
			/// </summary>
			public readonly static Field all_mt_user = new Field("all_mt_user","daily_report_today","下行总用户数");
			/// <summary>
			/// 下行去重总数
			/// </summary>
			public readonly static Field all_mt_dst_num = new Field("all_mt_dst_num","daily_report_today","下行去重总数");
			/// <summary>
			/// 下行去重用户数
			/// </summary>
			public readonly static Field all_mt_dst_user = new Field("all_mt_dst_user","daily_report_today","下行去重用户数");
			/// <summary>
			/// 成功下行总数
			/// </summary>
			public readonly static Field mt_succ_num = new Field("mt_succ_num","daily_report_today","成功下行总数");
			/// <summary>
			/// 成功下行去重数
			/// </summary>
			public readonly static Field mt_succ_dst_num = new Field("mt_succ_dst_num","daily_report_today","成功下行去重数");
			/// <summary>
			/// 成功下行用户数
			/// </summary>
			public readonly static Field mt_succ_user = new Field("mt_succ_user","daily_report_today","成功下行用户数");
			/// <summary>
			/// 成功下行去重用户数
			/// </summary>
			public readonly static Field mt_succ_dst_user = new Field("mt_succ_dst_user","daily_report_today","成功下行去重用户数");
			/// <summary>
			/// 总收入（分）
			/// </summary>
			public readonly static Field income = new Field("income","daily_report_today","总收入（分）");
			/// <summary>
			/// 日期
			/// </summary>
			public readonly static Field date_time = new Field("date_time","daily_report_today","日期");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field closed_cpid = new Field("closed_cpid","daily_report_today","closed_cpid");
		}
		#endregion
