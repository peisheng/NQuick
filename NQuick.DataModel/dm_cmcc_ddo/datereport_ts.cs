...
namespace NQuick.Model.DmCmccDdo
{
	...
	/// <summary>
	/// 实体类datereport_ts 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Table("datereport_ts")]
	[Serializable]
	public partial class datereport_ts : Entity 
	{
		#region Model
		private int _id;
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","datereport_ts");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field id = new Field("id","datereport_ts","id");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field tjdate = new Field("tjdate","datereport_ts","tjdate");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field province = new Field("province","datereport_ts","province");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field spname = new Field("spname","datereport_ts","spname");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field service_type = new Field("service_type","datereport_ts","service_type");
			/// <summary>
			/// 不知情投诉工单量
			/// </summary>
			public readonly static Field u_ts = new Field("u_ts","datereport_ts","不知情投诉工单量");
			/// <summary>
			/// 新增不知情投诉工单量
			/// </summary>
			public readonly static Field u_ts_new = new Field("u_ts_new","datereport_ts","新增不知情投诉工单量");
			/// <summary>
			/// 付费用户数
			/// </summary>
			public readonly static Field fee_user = new Field("fee_user","datereport_ts","付费用户数");
			/// <summary>
			/// 上月至今付费用户数
			/// </summary>
			public readonly static Field fee_user_all = new Field("fee_user_all","datereport_ts","上月至今付费用户数");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field add_time = new Field("add_time","datereport_ts","add_time");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field add_name = new Field("add_name","datereport_ts","add_name");
		}
		#endregion
