...
namespace NQuick.Model.DmCmccDdo
{
	...
	[Table("black_list")]
	[Serializable]
	public partial class black_list : Entity 
	{
		#region Model
		private int _id;
		...
		public class _
		{
			...
			/// 
			/// </summary>
			public readonly static Field id = new Field("id","black_list","id");
			/// <summary>
			/// 手机号
			/// </summary>
			public readonly static Field phone = new Field("phone","black_list","手机号");
			/// <summary>
			/// 加密后的手机号
			/// </summary>
			public readonly static Field phone_md5 = new Field("phone_md5","black_list","加密后的手机号");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field remark = new Field("remark","black_list","备注");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field addate = new Field("addate","black_list","addate");
		}
		#endregion
